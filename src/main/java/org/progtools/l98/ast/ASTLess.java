/* ASTLess.java : AST node for the less than operator.
 ...
 */
public class ASTLess extends ASTBinOp {
  ...
  */
  public ASTLess (int line, ASTExp left, ASTExp right) { super (line, left, right);}
