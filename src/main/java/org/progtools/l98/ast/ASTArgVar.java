/* ASTArgVar.java : AST node for arguments declared with var.
...
/**
 * AST node for arguments declared with var.
 */
public class ASTArgVar extends ASTArg {
   
  /**
   * @param line  where the expression was found.
   * @param id    argument's identifier.
   * @param type  arguments data type.
   */    
  public ASTArgVar (int line, String id, Type type) { 
    super (line, id, type);
  }
