/* ASTGreater.java : AST node for the greater than operator.
 ...
 */
public class ASTGreater extends ASTBinOp {
  ...
  */
  public ASTGreater (int line, ASTExp left, ASTExp right) { super (line, left, right);}
