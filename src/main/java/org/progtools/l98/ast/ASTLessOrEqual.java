/* ASTLessOrEqual.java : AST node for the less or equal than operator.
...
/**
 * AST node for the less or equal than operator.
 */
public class ASTLessOrEqual extends ASTBinOp {
  ...
  */
  public ASTLessOrEqual (int line, ASTExp left, ASTExp right) { super (line, left, right);}
