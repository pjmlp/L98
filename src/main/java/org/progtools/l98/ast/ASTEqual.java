/* ASTEqual.java : AST node for the equality operator.
 ...
 */
public class ASTEqual extends ASTBinOp {
  ...
  */
  public ASTEqual (int line, ASTExp left, ASTExp right) { super (line, left, right);}
